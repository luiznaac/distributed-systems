...
//        }
        ...
        InterfacePeer localPeerReference = new InterfacePeerImplementation("Peer2");
        ...
        try {
            listOfPeers.add((InterfacePeer) namesServiceReference.lookup("Peer1"));        
            listOfPeers.get(0).notifyPeer("Oi, peer1. Aqui é o peer2."
